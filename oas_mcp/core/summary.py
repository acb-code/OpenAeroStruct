"""Physics interpretation and narrative summary for OAS analysis results.

One summarize_* function per analysis type, each returning a dict with:
  - narrative:        2-3 rule-based sentences interpreting key results
  - derived_metrics:  computed from results + standard_detail
  - flags:            short actionable tags
  - delta:            signed changes vs previous run (or None)
"""
