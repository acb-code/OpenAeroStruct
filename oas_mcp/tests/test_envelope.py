...
import pytest
from oas_mcp.core.envelope import SCHEMA_VERSION, make_envelope, make_error_envelope
from oas_mcp.core.errors import (
    CacheEvictedError,
    InternalError,
    OASMCPError,
...
class TestErrorClasses:
    ...
    def test_all_errors_are_subclass_of_oasmcperror(self):
        for cls in [UserInputError, SolverConvergenceError, CacheEvictedError, InternalError]:
            assert issubclass(cls, OASMCPError)
