"""Unit tests for oas_mcp.core.builders path resolution, solver config, and split builders."""

import pytest

from oas_mcp.core.builders import (
    PathKind,
    SolverConfig,
    _SCALAR_DVS,
...
class TestSplitOptimizationBuilders:
    ...
    def test_build_aero_optimization_problem_setup(self, rect_surface):
        from oas_mcp.core.builders import build_aero_optimization_problem
    ...
    def test_build_aerostruct_optimization_problem_setup(self, rect_surface):
        from oas_mcp.core.builders import build_aerostruct_optimization_problem
    ...
    def test_dispatcher_matches_aero(self, rect_surface):
        from oas_mcp.core.builders import build_optimization_problem
