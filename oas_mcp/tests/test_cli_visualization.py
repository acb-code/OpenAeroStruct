...
from oas_mcp.core.session import Session, SessionDefaults
...
class TestDashboardHtml:
    ...
    def test_generates_html_for_valid_artifact(self):
        ...
        with patch("oas_mcp.core.artifacts.ArtifactStore") as MockStore:
...
class TestDashboardStarletteRoute:
    ...
    def test_viewer_paths_includes_dashboard(self):
        from oas_mcp.core.viewer_routes import _VIEWER_PATHS
