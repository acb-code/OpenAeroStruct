...
Tool implementations live in ``tools/`` submodules.  This module constructs the
FastMCP instance, registers all tools/resources/prompts, and provides the
``main()`` console-script entry point.

Backward-compatible re-exports ensure that ``from oas_mcp.server import X``
continues to work for all previously public names.
"""
...
from .core.auth import build_auth_settings, build_token_verifier, _env as _auth_env
...
from .tools.surfaces import create_surface
...
from .tools.session_tools import configure_session, reset, set_requirements
...
# that import ``from oas_mcp.server import _sessions, _artifacts, _get_viewer_base_url``
from .tools._state import sessions as _sessions, artifacts as _artifacts  # noqa: F401
from .tools._helpers import _get_viewer_base_url  # noqa: F401
